...
const DELAY_BETWEEN_REQUESTS = 1100; // 1.5 seconds delay between requests
...
app.get('/vn', async (req, res) => {
    try {
        const startPage = parseInt(req.query.startPage) || 400; // Default to page 1 if not provided
